...
if __name__ == '__main__':
    ...
    batched_riix_ratings = time_function(
        partial(run_riix_elo, dataset, 'batched'), 'batched riix elo', repetitions
    )
    batched_raax_ratings = time_function(
        partial(run_batched_raax_elo, matchups, outcomes, time_steps, dataset.num_competitors), 'batched raax elo', repetitions
    )
